...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="http://wordpress.org/support/article/network-admin/">Documentation on the Network Admin</a>' ) . '</p>' .
	'<p>' . __( '<a href="http://wordpress.org/support/forum/multisite/">Support Forums</a>' ) . '</p>'
);
